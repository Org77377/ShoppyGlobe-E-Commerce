...
export function ProductItem(data) {
    ...
    return (
        <>
            ...
            {/* main home screen with banners and featured products */}
            <div className="head-bar">
                <h1>Browse our products</h1>

                {/* search by name of the pruduct */}
                <input type="text" placeholder="search products" onChange={(e) => setSearch(e.target.value)} />
            </div>
            <div className="product-cont">
                {/* display the list of products using load status and search method implementation */}
